...
// static void set_dcx_control(void)
// {
//     gpiohs_set_pin(g_gpio_dcx, GPIO_PV_LOW);
// }
...
// static void set_dcx_data(void)
// {
//     gpiohs_set_pin(g_gpio_dcx, GPIO_PV_HIGH);
// }
...
// {
//     g_gpio_rst = RST_GPIONUM;
//     gpiohs_set_drive_mode(g_gpio_rst, GPIO_DM_OUTPUT);
//     gpiohs_set_pin(g_gpio_rst, GPIO_PV_LOW);
// }
...
// {
//     g_spi_num = SPI_CHANNEL;
//     g_dma_ch = DMAC_CHANNEL0;
//     g_ss = SPI_SLAVE_SELECT;
//     printf("\n  dcx init : ");
//     init_dcx();
//     printf("done\n  rst init : ");
//     init_rst();
